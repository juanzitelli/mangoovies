		...
		<Layout>
			<StyledHero>
				<StyledHeader>
					...
					<h3>Who needs the outside world? When you can watch a great movie! 🍿🤏</h3>
				</StyledHeader>
				...
				{
					!searchInputHasText && <StyledRecommendations>
			...
			{ searchInputHasText ? <Results query={searchText} /> : <Reccomendations />}
